import { getFirestore, setDoc, getDoc, getDocs, doc, collection, updateDoc, onSnapshot, arrayUnion} from "firebase/firestore";
...
export {
    app, auth, db,  setDoc, getDoc, doc, onSnapshot, updateDoc, arrayUnion
}
